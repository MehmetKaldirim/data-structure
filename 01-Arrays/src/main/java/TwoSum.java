...
public class TwoSum {
    public static void main(String[] args) {
        int[] myarray={2,7,13,15,16,18,20,21,25,27};
        System.out.println(Arrays.toString(twoSum1(myarray,42)));
        System.out.println("Optimal Solution .....");
        System.out.println(Arrays.toString(twoSum2(myarray,42)));
        System.out.println("Two Pointer Solution .....");
        System.out.println(Arrays.toString(mySolution(myarray,42)));
    }
    ...
    public static int[] mySolution(int[] array, int target){
